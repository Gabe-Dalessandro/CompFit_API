    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fitness_exp_title', models.ForeignKey(db_column='fitness_exp_title', null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.fitnessexperience', to_field='fitness_exp_title')),
                ('gender_desc', models.ForeignKey(db_column='gender_desc', null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.gender', to_field='gender_desc')),
            ],
            options={
                'db_table': 'user',
            },
